...
#define kJBFontInformationValue [UIFont fontWithName:@"HelveticaNeue-CondensedBold" size:75]
#define kJBFontInformationUnit [UIFont fontWithName:@"HelveticaNeue" size:20]
